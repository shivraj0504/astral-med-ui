	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'panel-fade-in': 'panel-fade-in 0.5s ease-out forwards',
				'ecg-line': 'ecg-line 8s linear infinite',
			...
			backgroundImage: {
				...
				'radial-glow': 'radial-gradient(circle, rgba(51,232,245,0.15) 0%, rgba(10,25,47,0) 70%)',
			},
		}
	},
